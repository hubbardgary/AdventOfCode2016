...
messages[0].length.times do |i|
  chars = Hash.new(0)
  messages.each { |m| chars[m[i]] += 1 }

  part1_message += chars.max_by{ |k, v| v }[0]
  part2_message += chars.min_by{ |k, v| v }[0]
end

puts "Part 1: #{part1_message}"
puts "Part 2: #{part2_message}"
